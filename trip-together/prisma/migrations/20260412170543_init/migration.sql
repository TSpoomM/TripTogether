-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('TRIP_OWNER', 'MEMBER', 'ADMIN');

-- CreateEnum
CREATE TYPE "TripStatus" AS ENUM ('OPEN', 'FINALIZED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Vote_destinationId_userId_key" ON "Vote"("destinationId", "userId");
...
-- AddForeignKey
ALTER TABLE "Destination" ADD CONSTRAINT "Destination_proposedById_fkey" FOREIGN KEY ("proposedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
